...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 400.0, 91.0, 22.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 280.0, 377.0, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 435.0, 389.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 435.0, 358.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 435.0, 327.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 435.0, 299.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 153.0, 58.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 153.0, 26.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 234.0, 101.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 191.0, 101.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 153.0, 101.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 377.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 219.0, 195.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 190.0, 202.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 161.0, 193.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.0, 137.0, 193.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 556.5, 734.0, 42.0, 23.0 ],
									"rnbo_classname" : ">=~",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 556.5, 706.0, 42.0, 23.0 ],
									"rnbo_classname" : "delta~",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 556.5, 766.0, 41.0, 23.0 ],
									"rnbo_classname" : "edge~",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 556.5, 842.0, 140.0, 23.0 ],
									"rnbo_classname" : "outport",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.0, 543.0, 107.0, 23.0 ],
									"rnbo_classname" : "r",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 88.0, 420.0, 80.0, 23.0 ],
									"rnbo_classname" : "r",
									"rnbo_serial" : 8,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 84.0, 82.0, 23.0 ],
									"rnbo_classname" : "s",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 114.0, 135.0, 211.0, 23.0 ],
...
,
									"text" : "param tempo 112 @min 1 @max 1000",
									"varname" : "tempo"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 114.0, 162.0, 61.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 88.0, 450.0, 35.0, 23.0 ],
									"rnbo_classname" : "<",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 88.0, 507.0, 31.0, 23.0 ],
									"rnbo_classname" : "gate",
									"rnbo_extra_attributes" : 									{
										"outputs" : 1.0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 477.5, 79.0, 107.0, 23.0 ],
									"rnbo_classname" : "lockedphase~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "lockedphase~_obj-23",
									"text" : "lockedphase~ 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 88.0, 47.0, 119.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"enum" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.0, 484.0, 23.0, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_serial" : 8,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.0, 452.0, 125.0, 23.0 ],
									"rnbo_classname" : "inport",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 183.0, 420.0, 258.0, 23.0 ],
									"rnbo_classname" : "buffer~",
									"rnbo_extra_attributes" : 									{
										"fill" : "",
										"type" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 88.0, 162.0, 24.0, 24.0 ],
									"rnbo_classname" : "toggle",
									"rnbo_extra_attributes" : 									{
										"preset" : 0,
										"order" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 8,
									"outlettype" : [ "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 88.0, 202.0, 92.5, 23.0 ],
...
,
					"patching_rect" : [ 206.0, 332.0, 40.0, 22.0 ],
					"rnboattrcache" : 					{
						"sampleOneLoop" : 						{
							"label" : "sampleOneLoop",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20230314.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "618203b8e040069a7908483cde010cf8"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 42.0, 299.0, 150.0, 22.0 ]
				}
...
, 			{
				"name" : "untitled_20230314.maxsnap",
